...
export default function Furniture() {
  ...
  async function fetchData() {
    ...
    try {
      ...
      const filteredFurniture = fetchedProducts.filter(product => product.category === "furniture");
      setProducts(filteredFurniture);
    } catch (error) {
  ...
  return (
    <>
      <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold p-10 text-start">Furniture</h1>
      <hr />
